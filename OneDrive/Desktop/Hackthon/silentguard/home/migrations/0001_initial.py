    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('agent', 'Mobile Money Agent'), ('student', 'Student'), ('vendor', 'Vendor'), ('other', 'Other')], max_length=30)),
                ('phonenumber', models.CharField(blank=True, max_length=15)),
                ('email', models.EmailField(blank=True, max_length=254, validators=[django.core.validators.RegexValidator(message='Enter a valid Ugandan phone number', regex='^07\\d{8}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_number', models.CharField(blank=True, max_length=20)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
